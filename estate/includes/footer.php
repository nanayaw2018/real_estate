        ...
        <script>
            jQuery(window).scroll(function(){
               var vscroll = jQuery(this).scrollTop();
                ...
                var vscroll = jQuery(this).scrollTop();
                jQuery('#back-flower').css({"transform" : "translate("+vscroll/5+",  -"+vscroll/12+"px)"
                });
            ...
            function details(id){
                var data = {"id":id};
                jQuery.ajax({
                    url : '/estate/includes/details.php',
                    method : "post", 
                    data : data, 
            ...
            function update_cart(mode, edit_id, edit_size){
                ...
                jQuery.ajax({
                    url: "/estate/admin/parsers/update_cart.php",
                    method: "post",
                    data: data,
                    success: function(data){
                        location.reload();
            ...
            function add_to_cart(){
                ...
                if(size == '' || quantity == '' || quantity == 0){
                    ...
                    jQuery.ajax({
                        url : '/estate/admin/parsers/add_cart.php',
                        method : 'post',
                        data : data,
                        success : function(){
                            location.reload();
